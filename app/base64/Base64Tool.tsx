...
import { Binary, Copy, Check, ArrowDown, ArrowUp, AlertCircle } from "lucide-react";
import type { Locale } from "@/lib/i18n";
import { i18n } from "@/lib/i18n";

export default function Base64Tool({ locale = "zh" }: { locale?: Locale }) {
  const t = i18n[locale].base64;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="flex items-center gap-2 mb-4 flex-wrap">
        <Binary size={16} className="text-terminal-purple" />
        <span className="font-mono text-sm text-terminal-green">base64</span>
      ...
      <div className="tool-container">
        <div className="tool-panel">
          <div className="tool-panel-header"><span>{mode === "encode" ? t.plainText : t.base64String}</span></div>
        ...
        <div className="tool-panel">
          <div className="tool-panel-header">
            <span>{mode === "encode" ? t.base64Output : t.decodedText}</span>
