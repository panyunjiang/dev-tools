...
export const metadata: Metadata = {
  ...
  description: i18n.zh.siteDesc,
  keywords: [
    "开发者工具", "JSON格式化", "正则测试", "Base64", "URL编解码",
    "时间戳转换", "Hash生成", "颜色转换", "Markdown预览", "在线工具", "前端工具",
  ],
  authors: [{ name: "DevTools" }],
  openGraph: {
    type: "website", locale: "zh_CN", url: "https://dev.aiv.yn.cn",
    siteName: "开发者工具箱", title: "开发者工具箱 | DevTools",
    description: i18n.zh.siteDesc,
  },
  robots: { index: true, follow: true },
  alternates: { languages: { en: "https://dev.aiv.yn.cn/en" } },
};
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mt-12 p-6 rounded-lg border border-terminal-border bg-terminal-card">
        <div className="font-mono text-xs space-y-1 text-terminal-muted">
          ...
          <p className="mt-3 text-terminal-text leading-relaxed text-sm">{t.about.zh}</p>
          <p className="mt-2 text-terminal-text leading-relaxed text-sm">{t.about.en}</p>
        </div>
      </div>
    </div>
  );
